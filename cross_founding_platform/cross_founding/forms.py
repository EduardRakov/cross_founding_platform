...
class BackerRegistrationForm(RegistrationFormUniqueEmail):
    ...
    first_name = forms.RegexField(
        ...
        min_length=2,
        label=_('First Name'),
        error_messages={'required': _(u'Input your first name'), 'invalid': _(u'First name must be letters only'),
    ...
    last_name = forms.RegexField(
        ...
        min_length=2,
        label=_('Last Name'),
        error_messages={'required': _(u'Input your last name'), 'invalid': _(u'Last name must be letters only'),
    ...
    def clean_dob_at(self):
        try:
            ...
            raise forms.ValidationError(_(u'Please input valid date'))
